  ...
  return (
    <div className="root">
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .ed-note-save { cursor: pointer; border: none; border-radius: 8px; padding: 6px 16px; font: inherit; font-size: 12.5px;
          font-weight: 700; background: var(--gold); color: #2a2410; }
        ...
        .reg-fab { position: fixed; right: 20px; bottom: 20px; z-index: 400; display: inline-flex; align-items: center; gap: 8px;
          background: var(--gold); color: #2a2410; border: none; border-radius: 999px; padding: 12px 18px; cursor: pointer;
        ...
        .reg-pill.on { background: var(--gold); color: #2a2410; border-color: var(--gold); }
        ...
        .reg-save { background: var(--gold); color: #2a2410; border: none; border-radius: 10px; padding: 9px 22px; font: inherit; font-weight: 700; cursor: pointer; }
      ...
      <div className="wrap">
        ...
        {view === "caixa" && (
          <CaixaView onBack={() => setView("main")} onArquivarEdital={arquivarNoEdital} />
        )}
