...
function JurisFonte({ infoData, onToggle, onBack, feitos, total }) {
  ...
  return (
    <section className="editais-page es-page">
      ...
      {/* Súmulas: moldura com 4 caixinhas rosa */}
        ...
        <div className="juris-cards">
          {JURIS_SECOES[0].itens.map((it) => (
            <button key={it.key} className="juris-card" onClick={() => setSub(it.key)}
              style={{ background: JURIS_SECOES[0].cor, color: JURIS_SECOES[0].txt }}>
              <span className="juris-card-nome">{it.curto}</span>
            </button>
          ))}
        </div>
      </div>

      {/* Teses (roxo) + Informativos (amarelo) na mesma moldura */}
      ...
      <div className="juris-panel">
        <div className="juris-cards">
          {JURIS_SECOES[1].itens.map((it) => (
            <button key={it.key} className="juris-card" onClick={() => setSub(it.key)}
              style={{ background: JURIS_SECOES[1].cor, color: JURIS_SECOES[1].txt }}>
              <span className="juris-card-nome">{it.curto}</span>
            </button>
          ))}
          <button className="juris-card" onClick={() => setSub("mege")}
            style={{ background: MEGE_COR, color: MEGE_TXT }}>
            <span className="juris-card-nome">Mege</span>
    ...
    <div className="root">
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .juris-secao-lbl { font-size: 16px; font-weight: 700; color: var(--text); margin: 6px 0 8px; }
        .juris-panel-head { display: flex; justify-content: space-between; align-items: baseline; max-width: 792px; margin: 20px 0 8px; }
        ...
        .juris-card { height: 128px; display: flex; flex-direction: column;
          ...
          box-shadow: 0 2px 8px rgba(0,0,0,.10); transition: transform .14s, box-shadow .14s, filter .14s; }
        .juris-card:hover { transform: translateY(-3px); filter: brightness(1.05); box-shadow: 0 8px 20px rgba(0,0,0,.20); }
        .juris-card-nome { font-size: 16px; font-weight: 800; line-height: 1.25; }
        .juris-card-cnt { font-size: 13px; font-weight: 800; opacity: .8; }
