...
function CronometroView({ crono, now, onPlay, onPause, onReset, onMode, onField, onPomoCfg, onSalvar, onBack }) {
  ...
  return (
    <section className="editais-page es-page cron-page">
      ...
      <p className="es-sub">Escolha a matéria, dê o play e estude. Quando parar, o tempo já vai pro seu registro.</p>
...
const CICLO_DIA_FONTES = ["teoria", "leiseca", "juris", "questoes", "revisao", "anki"];
const CICLO_METAS_DEFAULT = { teoria: 60, leiseca: 30, juris: 60, questoes: 60, revisao: 20, anki: 15 };
const CICLO_ROSCAS = [
