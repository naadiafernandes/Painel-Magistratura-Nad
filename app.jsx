...
export default function App() {
  ...
  const simGroups = (() => {
    const byYear = {};
    SIMULADOS.forEach((g) => {
      byYear[g.grupo] = (byYear[g.grupo] || []).concat(g.provas.filter((p) => !simHidden.includes(p)).map((p) => ({ nome: p, manual: false })));
    });
    ...
    <div className="root">
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .sidenav { gap: 6px; width: 218px; left: calc((100vw - 1080px)/2 - 240px); }
